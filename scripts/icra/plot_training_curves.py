...
plot_hv(ax1, cheetah_mdh_hv["_step"], cheetah_mdh_hv[HV_FILE], label = "MDH Hypervolume", color = "#236E7D", marker='.')
plot_hv(ax1, cheetah_mlp_hv["_step"], cheetah_mlp_hv[HV_FILE], label = "MDMLP Hypervolume", color = "#9136AA", marker='.')
# ax1.legend()
...
ax2 = ax1.twinx()
plot_hv(ax2, cheetah_mdh_sp["_step"], cheetah_mdh_sp[SP_FILE], label = "MDH Spacing", color = "#236E7D", linestyle = '--', marker='.')
plot_hv(ax2, cheetah_mlp_sp["_step"], cheetah_mlp_sp[SP_FILE], label = "MDMLP Spacing", color = "#9136AA", linestyle = '--', marker='.')
ax2.set_ylim([0, 0.3])
...
plot_hv(ax3, walker_mdh_hv["_step"], walker_mdh_hv[HV_FILE], color = "#236E7D", marker='.')
plot_hv(ax3, walker_mlp_hv["_step"], walker_mlp_hv[HV_FILE], color = "#9136AA", marker='.')
ax3.set_ylabel("Hypervolume")
ax3.set_xlabel("Training Steps")
codesign.dress_axis(ax3)
ax4 = ax3.twinx()
plot_hv(ax4, walker_mdh_sp["_step"], walker_mdh_sp[SP_FILE], color = "#236E7D", linestyle = '--', marker='.')
plot_hv(ax4, walker_mlp_sp["_step"], walker_mlp_sp[SP_FILE], color = "#9136AA", linestyle = '--', marker='.')
ax4.set_ylim([0, 0.5])
